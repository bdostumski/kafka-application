...
public class KafkaProducerConfig {
    ...
    public Map<String, Object> producerConfig() {
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class); // custom serializer this JsonSerializer comes from Spring Framework, not from Jackson
        // props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, StringSerializer.class); // Configuration for string
        return props;
    }
